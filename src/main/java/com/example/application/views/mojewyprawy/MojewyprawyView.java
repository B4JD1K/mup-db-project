package com.example.application.views.mojewyprawy;
...
@PageTitle("Moje wyprawy")
@Route(value = "list", layout = MainLayout.class)
@PermitAll
public class MojewyprawyView extends Div {
    ...
    public MojewyprawyView() {
        addClassName("mojewyprawy-view");
        setSizeFull();
        createGrid();
        add(grid);
    }

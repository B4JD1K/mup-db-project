package com.example.application.views.atrakcjeturystyczne;
...
@PageTitle("Atrakcje turystyczne")
@Route(value = "master-detail/:sampleBookID?/:action?(edit)", layout = MainLayout.class)
@AnonymousAllowed
public class AtrakcjeturystyczneView extends Div implements BeforeEnterObserver {
    ...
    public AtrakcjeturystyczneView(SampleBookService sampleBookService) {
        this.sampleBookService = sampleBookService;
        addClassNames("atrakcjeturystyczne-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(AtrakcjeturystyczneView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleBookId.isPresent()) {
            ...
            if (sampleBookFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(AtrakcjeturystyczneView.class);
            }
        }
    }
